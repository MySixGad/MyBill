...
public class MyHelper extends SQLiteOpenHelper {
	...
	public MyHelper(Context context) {
		super(context, "bill_db.db", null, 1);
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("create table income_table(id Integer primary key,income_date text,income_person text,"
				+ "income_type text,income_detail text,income_rmb Integer,income_way text,other text,rember_person text,rember_date text)");

		db.execSQL("create table user_info(id Integer primary key,income_date text,income_person text,"
